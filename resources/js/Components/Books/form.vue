            ...
            <div
                ...
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="">
                            <div class="mb-4">
                                <label for="formBookMajor"
                                    class="block text-gray-700 text-sm font-bold mb-2">Major: </label>
                                <select
                                    v-model="form.major"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="formBookMajor">
                                    <option value="">Select Major</option>
                                    <option v-for="major in majors" :key="major.id" :value="major.id">{{ major }}</option>
                                </select>
                                <div v-if="$page.props.errors.major" class="text-red-500">{{ $page.props.errors.major }}</div>
                            </div>
                            <div class="mb-4">
...
<script>
    ...
    export default {
        props: ['form', 'isOpen', 'isEdit','majors'],
        components: {
            FilePond
        },
