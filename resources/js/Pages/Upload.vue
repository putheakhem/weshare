  ...
  <AuthenticatedLayout>
    <div class="py-11">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white  overflow-hidden drop-shadow-xl shadow-indigo-500/40 sm:rounded-lg">
          <div
            class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-5 lg:grid-cols-12 "
          >
            <div class="mr-auto place-self-center lg:col-span-7 ">
              <form @submit.prevent="form.post('/uploadfile')">
            ...
            <div class=" hidden lg:mx-auto lg:col-span-5 lg:flex">
          <img src="https://img.freepik.com/premium-vector/student-woman-with-laptop-studying-online-course-online-education-concept-vector-illustration-flat_186332-1147.jpg?w=2000" alt="mockup" class="object-cover object-center w-full h-auto lg:h-full"/>
        </div>
          </div>
        </div>
      </div>
