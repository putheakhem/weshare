                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Upload File Navigation IF user not yet Login -->
                            <div v-if="!$page.props.auth.user" class="inline-flex">
                                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    <button href="/" @click="showWarn">
                            ...
                            <div v-if="$page.props.auth.user" class="inline-flex">
                                <div v-if="$page.props.auth.user.role == 0"
                                    ...
                                    <NavLink :href="route('manage_files')" :active="route().current('manage_files')
                                        ">
                                        Manage Files
                                    </NavLink>
                                    <NavLink :href="route('manage_majors')" :active="route().current('manage_majors')
                                        ">
                                        Manage Majors
                                    </NavLink>
                                    <NavLink :href="route('manage_types')" :active="route().current('manage_types')
                                        ">
                                        Manage Types
                                    </NavLink>
                                ...
                                <div v-else class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    ...
                                    <NavLink :href="route('favourite_items')" :active="route().current('favourite_items')
                                        ">
                                        My Favourites
                                    </NavLink>
                                    <NavLink :href="route('my_documents')" :active="route().current('my_documents')">
                                        My Documents
                                    </NavLink>
                                </div>
                            </div>
                ...
                <div :class="{
                    ...
                    <div v-if="!$page.props.auth.user ||
                        ...
                        <div class="pt-2 pb-3 space-y-1">
                            <ResponsiveNavLink href="#aboutus">
                                About Us
                            </ResponsiveNavLink>
                        </div>
                    </div>
                    ...
                    <div v-if="!$page.props.auth.user" class="inline-flex">
                        <div class="pt-2 pb-3 space-y-1">
                            <button class="pl-4" href="/" @click="showWarn">
                                <span class="text-gray-500 font-medium text-sm">Upload File</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div v-if="$page.props.auth.user">
                        <div v-if="$page.props.auth.user.role == 0" class="pt-2 pb-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('manage_files')" :active="route().current('manage_files')">
                                Manage Files
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('manage_majors')" :active="route().current('manage_majors')">
                                Manage Majors
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('manage_types')" :active="route().current('manage_types')">
                                Manage Types
                            </ResponsiveNavLink>
                        ...
                        <div v-else>
                            ...
                            <ResponsiveNavLink :href="route('favourite_items')"
                                :active="route().current('favourite_items')">
                                My Favourites
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('my_documents')" :active="route().current('my_documents')">
                                My Documents
                            </ResponsiveNavLink>
                        </div>
                    </div>
